...
public sealed class NexoMailDbContext(DbContextOptions<NexoMailDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MailIndexStateEntity>(entity =>
        {
            ...
            entity.Property(x => x.LastReconciliationErrorCode).HasMaxLength(32);
            entity.Property(x => x.BackfillPageToken).HasMaxLength(4000);
            entity.Property(x => x.GmailHistoryId).HasMaxLength(128);

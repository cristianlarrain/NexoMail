...
public sealed class MailIndexStateEntity { public Guid AccountId { get; set; } public Guid UserId { get; set; } public DateTimeOffset LastIndexedAt { get; set; } public int WindowDays { get; set; } public int IndexedMessageCount { get; set; } public string? SyncLeaseOwner { get; set; } public DateTimeOffset? SyncLeaseUntil { get; set; } }
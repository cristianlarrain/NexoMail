...
export function AdminPlansPage() {
  ...
  return <section className="settings-page commercial-admin-page">
    <div className="commercial-admin-header">
      ...
      <div className="commercial-admin-header-actions"><Link to="/admin/users" className="secondary-button"><ArrowLeft size={16} /> Panel de Administración</Link><Link to="/settings/plan" className="secondary-button">Plan y uso</Link><button type="button" className="primary-button" onClick={openNew}><Plus size={16} /> Nuevo tipo</button></div>
    </div>

...
export function MessagePage() {
  ...
  const canArchive = !isArchived && message.folderId !== 'sent' && message.folderId !== 'drafts' && message.folderId !== 'spam' && message.folderId !== 'trash'

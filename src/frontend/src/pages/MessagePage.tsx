...
export function MessagePage() {
  ...
  return <article className={`mail-view message-reader ${preview ? 'with-preview' : ''}`}>
    ...
    <ConfirmDialog open={confirmTrash} title="Mover correo a Papelera" message="El correo dejará de aparecer en la Bandeja de entrada y podrá restaurarse desde Papelera." confirmLabel="Mover a Papelera" pending={trash.isPending} onCancel={() => setConfirmTrash(false)} onConfirm={() => trash.mutate()} />
  </article>
}

...
export function ComposePage() {
  ...
  function useAiProposal(suggestion: AiWritingSuggestion) { if (!origin && suggestion.subject?.trim()) setSubject(suggestion.subject.trim()); const html = textToHtml(suggestion.text); setBody(html); if (editor.current) { editor.current.innerHTML = html; editor.current.focus() } }

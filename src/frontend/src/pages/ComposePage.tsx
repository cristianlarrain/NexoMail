...
export function ComposePage() {
  ...
  function useAiProposal(text: string) { const html = textToHtml(text); setBody(html); if (editor.current) { editor.current.innerHTML = html; editor.current.focus() } }

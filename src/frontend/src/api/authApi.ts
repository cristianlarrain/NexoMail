...
export const authApi = {
  ...
  updateProfile: (request: { displayName: string; avatarDataUrl: string | null }) => authRequest<AuthSession>('/me', { method: 'POST', body: JSON.stringify(request) }) as Promise<AuthSession>,
